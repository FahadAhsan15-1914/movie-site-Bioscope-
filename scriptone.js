...
document.getElementById("loginbutton").addEventListener("click", popup);
...
//for hollywood buttone

document.getElementById("hollywood").addEventListener("click", addHollywood);
document.getElementById("bollywood").addEventListener("click", addBollywood);
document.getElementById("tamil").addEventListener("click", addTamil);
          ...
          <div class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="card">
                    <video poster="../Poster/bollywood/Highway.jpg" style="height:auto;width:100%" controls>
                            ...
                            <source src="../videos/Bollywood/yt1s.com%20-%20Highway%20%20Official%20Trailer%20%20Alia%20Bhatt%20Randeep%20Hooda%20%20Imtiaz%20Ali_720p.mp4" type="video/mp4" />
                        </video>
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4">
                    <div class="card">
                        <video poster="../poster/battleship.jpg"style="height:auto;width:100%" controls>
                       
                                <source src="../videos/Battleship%20_%20The%20Final%20Battle%20in%204K%20HDR.mp4" type="video/mp4" />
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4">
                    <div class="card">
                        <video poster="../poster/Avater2.jpg" controls="controls" style="height:auto;width:100%" controls>
                                <source src="../videos/AVATAR%202%20-%20Official%20Trailer%20_%20James%20Cameron%20_%20Avatar%202%20_%20Official%20_%20Trailer.mp4" type="video/mp4" />                         
                        </video>
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4">
                    <div class="card">
                        <video poster="../Poster/kong.jpg" style="height:auto;width:100%" controls>                           
                                <source src="../videos/Kong_%20Skull%20Island%20(2017)%20-%20Kong%20vs.%20Giant%20Squid%20Scene%20(3_10)%20_%20Movieclips%20(1).mp4" type="video/mp4" />                        
                        </video>
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4">
                    <div class="card">
                        <video poster="../Poster/mortal combat.jpg" style="height:auto;width:100%" controls>                          
                                <source src="../videos/MORTAL%20KOMBAT%20Trailer%20(2021).mp4" type="video/mp4" />
                            </video>
                        <div class="card-body">
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4">
                    <div class="card">
                        <video poster="../Poster/transformer.jpeg" style="height:auto;width:100%" controls>
                                ...
                                <source src="../videos/Transformers_%20Dark%20of%20the%20Moon%20(2011)%20-%20Freeway%20Chase%20-%20Only%20Action%20[4K].mp4" type="video/mp4" />
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4">
                    <div class="card">
                        <video poster="../Poster/Ramy 2.jpg" style="height:auto;width:100%" controls>
                                ...
                                <source src="../videos/RAMY%202%20Trailer%20(2020).mp4" type="video/mp4" />
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4">
                    <div class="card">
                        <video poster="../Poster/the great wall.jpeg" style="height:auto;width:100%" controls>
                                ...
                                <source src="../videos/The%20Great%20Wall%20-%20Opening%20Battle%20(2016).mp4" type="video/mp4" />
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4">
                    <div class="card">
                        <video poster="../Poster/Thor 4 love and thunder.jpg" style="height:auto;width:100%" controls>
                                ...
                                <source src="../videos/Thor%204%20love%20and%20thunder%20Official%20Trailer%20_%20new%20movie%202021%20hollywood%20Concept.mp4" type="video/mp4" />
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4">
                    <div class="card">
                        <video poster="../Poster/venom 2.jpg" style="height:auto;width:100%" controls>
                                ...
                                <source src="../videos/VENOM%202%20(2021)%20LET%20THERE%20BE%20CARNAGE%20%e2%80%94%20First%20Trailer%20Concept%20_%20Tom%20Hardy%20_%20Woody%20Harrelson.mp4" type="video/mp4" />
                        </video>
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4">
                    <div class="card">
                        <video poster="../Poster/Logan.jpeg" style="height:auto;width:100%" controls>
                                ...
                                <source src="../videos/Logan_%20The%20Wolverine%20Return%20'Teaser%20Trailer'(2021)%20Hugh%20Jackman,%20Ryan%20Reynolds,%20Dafne%20Knee%20_Concept_.mp4" type="video/mp4" />
                            </video>
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4">
                    <div class="card">
                        <video poster="../Poster/justice.jpg" style="height:auto;width:100%" controls>
                                ...
                                <source src="../videos/JUSTICE%20LEAGUE_%20The%20Snyder%20Cut%20Trailer%202%20(2021).mp4" type="video/mp4" />
                            </video>
...
//Bollywood 
function addBollywood() {

    document.getElementById("container").innerHTML =  `<div class="col-12 col-md-6 col-lg-4 mb-4">
    <div class="card">
        <video poster="Poster/bollywood/Highway.JPG" style="height:auto;width:100%" controls>
